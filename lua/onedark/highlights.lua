...
hl.treesitter = {
    ...
    ["@field"] = colors.Cyan,
    ["@float"] = colors.Orange,
    ["@function"] = colors.BGBlue,
    ["@function.builtin"] = colors.Cyan,
    ["@function.macro"] = colors.Fg,
    ["@include"] = {fg = c.purple, italic = cfg.italic_comment},
    ...
    ["@punctuation.bracket"] = {fg = c.fg, bold = true},
    ...
    ["@text.emphasis"] = colors.Fg,
    ["@text.underline"] = colors.Fg,
    ["@text.strike"] = colors.Fg,
    ["@text.title"] = colors.Fg,
    ["@text.literal"] = colors.Green,
    ["@text.uri"] = colors.Fg,
    ["@text.math"] = colors.Fg,
    ["@text.reference"] = colors.Fg,
