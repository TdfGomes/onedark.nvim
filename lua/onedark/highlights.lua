...
if vim.api.nvim_call_function("has", { "nvim-0.8" }) == 1 then
    hl.treesitter = {
        ...
        ["@keyword.function"] = {fg = c.purple, fmt = "bold,italic"},
        ["@keyword.import"] =  {fg = c.purple, fmt = "italic"},
        ["@keyword.operator"] =  {fg = c.purple, fmt = cfg.code_style.keywords},
        ["@keyword.repeat"] = {fg = c.purple, fmt = cfg.code_style.keywords},
        ["@keyword.coroutine"] = {fg = c.purple, fmt = "italic"},
        ["@label"] = colors.Red,
        ...
        ["@punctuation.bracket"] = {fg = c.light_grey, fmt = 'bold'},
        ["@punctuation.special"] = {fg = c.light_grey, fmt = 'bold'},
        ["@string"] = {fg = c.green, fmt = cfg.code_style.strings},
        ...
        ["@tag"] = {fg = c.yellow, fmt = 'bold'},
        ["@tag.attribute"] = {fg = c.orange, fmt= 'bold'}, 
        ["@tag.delimiter"] = {fg = c.red, fmt = 'bold'},
        ["@tag.builtin"] = colors.Red,
        ["@text"] = colors.Fg,
        ["@note"] = colors.Fg,
        ["@warning"] = colors.Fg,
        ["@danger"] = colors.Fg,
        ...
        ["@constant"] = {fg = c.orange, fmt = cfg.code_style.variables},
